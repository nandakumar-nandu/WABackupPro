...
import com.wabackuppro.databinding.FragmentHistoryBinding
...
class BackupHistoryFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        historyAdapter = HistoryAdapter { record ->
            if (_binding == null) return@HistoryAdapter
     ...
     * in memory, updating the adapter with filtered BackupRecord items.
     */
